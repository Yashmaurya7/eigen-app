...
//           <p className="text-lg text-gray-300 mt-4">
//            A better world - More Precise and faster discoveries
//           </p>
//         </div>
//       </div>
//     </div>
...
export function CompareDemo() {
  return (
    <div className="min-h-screen bg-black  flex flex-col items-center gap-8 pt-32  ">
      {/* Heading */}
      <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold text-blue-600 text-center p-8">
        Redefining Healthcare using AI into a better world
      </h1>
      ...
      <div className="flex flex-col md:flex-row items-center justify-between w-full gap-8">
        {/* Left Text Block */}
        <div className="w-full md:w-1/4 bg-black p-4 rounded-lg shadow-lg flex flex-col justify-center">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-600">The Present</h1>
          <p className="text-lg text-gray-300 mt-4">
            Struggling with inefficiencies, inaccuracy and longer gestation period
          </p>
        </div>
        ...
        {/* Right Text Block */}
        <div className="w-full md:w-1/4 bg-black p-4 rounded-lg shadow-lg flex flex-col justify-center pl-4">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-extrabold text-blue-600">The Future</h1>
          <p className="text-lg text-gray-300 mt-4">
           A better world - More Precise and faster discoveries
          </p>
        </div>
