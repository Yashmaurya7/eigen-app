  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto py-20 px-4 md:px-8 lg:px-10">
        <h2 className="text-6xl md:text-6xl  mb-4 text-black dark:text-blue-600 max-w-4xl">
        <b>A Brief</b>
        </h2>
        <p className="text-neutral-700 dark:text-neutral-300 text-xl md:text-xl max-w-xl">
